                ...
                <div className="flex-1 overflow-y-auto p-8 lg:p-12 text-left font-p5-ui custom-scrollbar pb-24">
                    <div className="border-l-4 border-p5-cyan bg-p5-cyan/5 p-6 mb-8 transform -skew-x-2">
                        <div className="transform skew-x-2">
                            <h3 className="text-2xl font-p5-display text-p5-cyan mb-3 tracking-widest outline-text">VERSION 1.1.1 (CURRENT)</h3>
                            <ul className="list-disc list-inside space-y-3 text-white/90 text-sm lg:text-base">
                                <li><span className="text-p5-yellow font-bold">FIXED:</span> Solved input delay. Keyboards and controllers feel instantaneous with zero lag.</li>
                                <li><span className="text-p5-cyan font-bold">IMPROVED:</span> Ultra-snappy piece rotation. No more missed double-rotations or sluggish movements!</li>
                                <li><span className="text-p5-green font-bold">PERFORMANCE:</span> Removed transition delays and slow DOM updates inside the grid, maximizing overall FPS.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="border-l-4 border-p5-purple bg-p5-purple/5 p-6 mb-8 transform -skew-x-2 opacity-70 hover:opacity-100 transition-opacity">
                        <div className="transform skew-x-2">
                            <h3 className="text-xl font-p5-display text-p5-purple mb-3 tracking-widest outline-text">VERSION 1.1.0</h3>
                            <ul className="list-disc list-inside space-y-3 text-white/90 text-sm lg:text-base">
